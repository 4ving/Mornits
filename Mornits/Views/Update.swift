...
private class UpdateView: NSView {
    ...
    internal func noUpdates() {
        ...
        title.stringValue = localizedString("The latest version of Mornits installed")
    ...
    @objc private func changelog() {
        if let version = self.version {
            NSWorkspace.shared.open(URL(string: "https://github.com/4ving/Mornits/releases/tag/\(version.latest)")!)
        }
    }
