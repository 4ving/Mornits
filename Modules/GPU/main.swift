...
public class GPUs: Codable, RemoteType {
    private var queue: DispatchQueue = DispatchQueue(label: "com.4ving.Mornits.GPU.SynchronizedArray")
...
public class GPU: Module {
    ...
    private let settingsView: GPUSettings
    ...
    public init() {
        ...
        self.settingsView = GPUSettings(.GPU)
