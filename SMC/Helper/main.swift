...
class Helper: NSObject, NSXPCListenerDelegate, HelperProtocol {
    ...
    override init() {
        self.listener = NSXPCListener(machServiceName: "com.4ving.Mornits.SMC.Helper")
        super.init()
    ...
    private func uninstallHelper() {
        ...
        process.arguments = ["unload", "/Library/LaunchDaemons/com.4ving.Mornits.SMC.Helper.plist"]
        process.launch()
        ...
        do {
            try FileManager.default.removeItem(at: URL(fileURLWithPath: "/Library/LaunchDaemons/com.4ving.Mornits.SMC.Helper.plist"))
        } catch let err {
        ...
        do {
            try FileManager.default.removeItem(at: URL(fileURLWithPath: "/Library/PrivilegedHelperTools/com.4ving.Mornits.SMC.Helper"))
        } catch let err {
...
extension Helper {
    ...
    func uninstall() {
        let process = Process()
        process.launchPath = "/Library/PrivilegedHelperTools/com.4ving.Mornits.SMC.Helper"
        process.qualityOfService = QualityOfService.userInitiated
