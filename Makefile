...
prepare-dmg:
	...
	./create-dmg/create-dmg \
	    --volname $(APP) \
	    --background "./Mornits/Supporting Files/background.png" \
	    --window-pos 200 120 \
	    --window-size 500 320 \
	    --icon-size 80 \
	    --icon "Mornits.app" 125 175 \
	    --hide-extension "Mornits.app" \
...
next-version:
	versionNumber=$$(/usr/libexec/PlistBuddy -c "Print CFBundleVersion" "$(PWD)/Mornits/Supporting Files/Info.plist") ;\
	echo "Actual version is: $$versionNumber" ;\
	versionNumber=$$((versionNumber + 1)) ;\
	echo "Next version is: $$versionNumber" ;\
	/usr/libexec/PlistBuddy -c "Set :CFBundleVersion $$versionNumber" "$(PWD)/Mornits/Supporting Files/Info.plist" ;\
